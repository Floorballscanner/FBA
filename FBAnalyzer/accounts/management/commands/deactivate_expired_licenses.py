...
class Command(BaseCommand):
    help = (
        ...
        "Trial licenses (trial/fliiga_trial) leave the User active so they can still "
        "log in and see the license_required 'buy a license' message instead of a bare "
        "login error."
    )

    TRIAL_TIERS = ('trial', 'fliiga_trial')
    ...
    def handle(self, *args, **options):
        ...
        for license in expired:
            ...
            if license.tier not in self.TRIAL_TIERS:
