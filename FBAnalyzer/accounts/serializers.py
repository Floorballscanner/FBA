...
class LiveDataSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'xGaPeriodT2L7', 'xGaGameT2L7', 'toPeriodT1', 'toPeriodT2', 'toGameT1', 'toGameT2', 'toPeriodT1L1', 'toPeriodT2L1',
            'toPeriodT1L2', 'toPeriodT2L2', 'toPeriodT1L3', 'toPeriodT2L3', 'toGameT1L1', 'toGameT2L1',
            'toGameT1L2', 'toGameT2L2', 'toGameT1L3', 'toGameT2L3'
