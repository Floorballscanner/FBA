...
urlpatterns = [
    ...
    path('accounts/fliiga_stats_api/', views.fliiga_stats_api, name="fliiga-stats-api"),
    path('accounts/fliiga_team_analysis/', views.fliiga_team_analysis, name="fliiga-team-analysis"),
    path('accounts/fliiga_team_list_api/', views.fliiga_team_list_api, name="fliiga-team-list-api"),
    path('accounts/fliiga_team_stats_api/', views.fliiga_team_stats_api, name="fliiga-team-stats-api"),
    path('accounts/fliiga_comparison_api/', views.fliiga_comparison_api, name="fliiga-comparison-api"),
