...
/*        csv_time = arrayToCsv(premTimeData);
    ...
    function undoButton() {
        ...
        sf_p = undo_object.sf_p;
        sa_p = undo_object.sa_p;
        gf_p = undo_object.gf_p;
        ga_p = undo_object.ga_p;
        pm_p = undo_object.pm_p;
        bf_p = undo_object.bf_p;
        ba_p = undo_object.ba_p;
        mf_p = undo_object.mf_p;
        ma_p = undo_object.ma_p;
        saf_p = undo_object.saf_p;
        saa_p = undo_object.saa_p;
        xf_p = undo_object.xf_p;
        xa_p = undo_object.xa_p;
        sf_g = undo_object.sf_g;
        sa_g = undo_object.sa_g;
        gf_g = undo_object.gf_g;
        ga_g = undo_object.ga_g;
        pm_g = undo_object.pm_g;
        bf_g = undo_object.bf_g;
        ba_g = undo_object.ba_g;
        mf_g = undo_object.mf_g;
        ma_g = undo_object.ma_g;
        saf_g = undo_object.saf_g;
        saa_g = undo_object.saa_g;
        xf_g = undo_object.xf_g;
        xa_g = undo_object.xa_g;

        sfT2_p = undo_object.sfT2_p;
        saT2_p = undo_object.saT2_p;
        gfT2_p = undo_object.gfT2_p;
        gaT2_p = undo_object.gaT2_p;
        pmT2_p = undo_object.pmT2_p;
        bfT2_p = undo_object.bfT2_p;
        baT2_p = undo_object.baT2_p;
        mfT2_p = undo_object.mfT2_p;
        maT2_p = undo_object.maT2_p;
        safT2_p = undo_object.safT2_p;
        saaT2_p = undo_object.saaT2_p;
        xfT2_p = undo_object.xfT2_p;
        xaT2_p = undo_object.xaT2_p;
        sfT2_g = undo_object.sfT2_g;
        saT2_g = undo_object.saT2_g;
        gfT2_g = undo_object.gfT2_g;
        gaT2_g = undo_object.gaT2_g;
        pmT2_g = undo_object.pmT2_g;
        bfT2_g = undo_object.bfT2_g;
        baT2_g = undo_object.baT2_g;
        mfT2_g = undo_object.mfT2_g;
        maT2_g = undo_object.maT2_g;
        safT2_g = undo_object.safT2_g;
        saaT2_g = undo_object.saaT2_g;
