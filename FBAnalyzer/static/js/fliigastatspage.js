...
async function main() {
    ...
    st_playerchart_data.addColumn('string', 'A');
    st_playerchart_data.addColumn('string', 'P');
    st_playerchart_data.addColumn('string', 'S');
    st_playerchart_data.addColumn('string', 'SM');
    st_playerchart_data.addColumn('string', '+');
    st_playerchart_data.addColumn('string', '-');
