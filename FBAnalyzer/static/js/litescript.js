...
popup.innerHTML = `
  ...
  <form>
    <div class="form-check">
      <input class="form-check-input" type="radio" name="shotType" id="wristShot" value="wrist">
      <label class="form-check-label" for="wristShot">
        Wrist Shot
      </label>
    </div>
    <div class="form-check">
      <input class="form-check-input" type="radio" name="shotType" id="slapShot" value="slap">
      <label class="form-check-label" for="slapShot">
        Slap Shot
      </label>
    </div>
...
form.addEventListener("submit", function(event) {
      ...
      // Get form input
      const shotType = form.elements["shotType"].value;
