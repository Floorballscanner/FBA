...
function lineCard(line) {
    ...
    return '<div class="team-line-card">'
        ...
        + '<div class="team-line-card__caption">Last ' + line.games + ' ' + (line.games === 1 ? 'game' : 'games') + '</div>'
        + '<div class="team-line-slots">' + playersHtml + '</div>'
        + '<div class="team-line-kpis">'
        + '<span>' + line.shots_per_game + ' shots/game</span>'
        + '<span>' + line.goals_per_game + ' goals/game</span>'
        + '<span>' + line.xg_per_game + ' xG/game</span>'
        + '<span>' + line.xgot_per_game + ' xGOT/game</span>'
        + '<span>' + line.gaxg_per_game + ' GAxG/game</span>'
        + '</div>'
