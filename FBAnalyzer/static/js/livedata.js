...
function initializeLive() {
    ...
    data = {
        ...
        "goalsPeriodT1": ~~totp_1.innerHTML,
        "goalsGameT1": ~~totg_1.innerHTML,
        "xGPeriodT1": xGf_p[7],
        "xGGameT1": xGf_g[7],
        "nameT2": name_t2,
        "lineOnT2": line_on_2,
        ...
        "goalsPeriodT2": ~~totp_2.innerHTML,
        "goalsGameT2": ~~totg_2.innerHTML,
        "xGPeriodT2": xGfT2_p[7],
        "xGGameT2": xGfT2_g[7],
        "toPeriodT1": stT1Teamp_array[0]+stT1Teamp_array[1],
        "toGameT1": stT1Teamg_array[0]+stT1Teamg_array[1],
        "toPeriodT2": stT2Teamp_array[0]+stT2Teamp_array[1],
        "toGameT1": stT2Teamg_array[0]+stT2Teamg_array[1],
        "nameL1": "Line 1",
        ...
        "toPeriodT1L1": stT1L1p_array[0]+stT1L1p_array[1],
        "toGameT1L1": stT1L1g_array[0]+stT1L1g_array[1],
        "toPeriodT2L1": stT2L1p_array[0]+stT2L1p_array[1],
        "toGameT1L1": stT2L1g_array[0]+stT2L1g_array[1],
        "nameL2": "Line 2",
        ...
        "toPeriodT1L2": stT1L2p_array[0]+stT1L2p_array[1],
        "toGameT1L2": stT1L2g_array[0]+stT1L2g_array[1],
        "toPeriodT2L2": stT2L2p_array[0]+stT2L2p_array[1],
        "toGameT1L2": stT2L2g_array[0]+stT2L2g_array[1],
        "nameL3": "Line 3",
        ...
        "toPeriodT1L3": stT1L3p_array[0]+stT1L3p_array[1],
        "toGameT1L3": stT1L3g_array[0]+stT1L3g_array[1],
        "toPeriodT2L3": stT2L3p_array[0]+stT2L3p_array[1],
        "toGameT1L3": stT2L3g_array[0]+stT2L3g_array[1],
        "nameL4": "Powerplay 1",
...
function updateLive() {
    ...
    data = {
        ...
        "xGaPeriodT2L1": xGaT2_p[0],
        "xGaGameT2L1": xGaT2_g[0],
        "toPeriodT1L1": stT1L1Teamp_array[0]+stT1L1Teamp_array[1],
        "toGameT1L1": stT1L1Teamg_array[0]+stT1L1Teamg_array[1],
        "toPeriodT2L1": stT2L1Teamp_array[0]+stT2L1Teamp_array[1],
        "toGameT1L1": stT2L1Teamg_array[0]+stT2L1Teamg_array[1],
        "nameL2": "Line 2",
        "possessionPeriodT1L2": Pos_p[1],
        "possessionGameT1L2": Pos_g[1],
        "gfPeriodT1L2": ~~gfL2p.innerHTML,
        ...
        "xGaPeriodT2L2": xGaT2_p[1],
        "xGaGameT2L2": xGaT2_g[1],
        "toPeriodT1L2": stT1L2Teamp_array[0]+stT1L2Teamp_array[1],
        "toGameT1L2": stT1L2Teamg_array[0]+stT1L2Teamg_array[1],
        "toPeriodT2L2": stT2L2Teamp_array[0]+stT2L2Teamp_array[1],
        "toGameT1L2": stT2L2Teamg_array[0]+stT2L2Teamg_array[1],
        "nameL3": "Line 3",
        "possessionPeriodT1L3": Pos_p[2],
        "possessionGameT1L3": Pos_g[2],
        "gfPeriodT1L3": ~~gfL3p.innerHTML,
        ...
        "xGaPeriodT2L3": xGaT2_p[2],
        "xGaGameT2L3": xGaT2_g[2],
        "toPeriodT1L3": stT1L3Teamp_array[0]+stT1L3Teamp_array[1],
        "toGameT1L3": stT1L3Teamg_array[0]+stT1L3Teamg_array[1],
        "toPeriodT2L3": stT2L3Teamp_array[0]+stT2L3Teamp_array[1],
        "toGameT1L3": stT2L3Teamg_array[0]+stT2L3Teamg_array[1],
        "nameL4": "Powerplay 1",
        "possessionPeriodT1L4": Pos_p[3],
        "possessionGameT1L4": Pos_g[3],
        "gfPeriodT1L4": ~~gfPP1p.innerHTML,
