...
function initializeLive() {
    ...
    data = {
        ...
        "nameT1": name_t1,
        "lineOnT1": line_on,
        "possessionPeriodT1": Pos_p[7] +  Pos_p[3] + Pos_p[4] + Pos_p[5] + Pos_p[6],
        "possessionGameT1": Pos_g[7] + Pos_g[3] + Pos_g[4] + Pos_g[5] + Pos_g[6],
        "goalsPeriodT1": ~~totp_1.innerHTML,
        "goalsGameT1": ~~totg_1.innerHTML,
        "xGPeriodT1": xGf_p[7] + xGf_p[3] + xGf_p[4] + xGf_p[5] + xGf_p[6],
        "xGGameT1": xGf_g[7] + xGf_g[3] + xGf_g[4] + xGf_g[5] + xGf_g[6],
        "nameT2": name_t2,
        "lineOnT2": line_on_2,
        "possessionPeriodT2": PosT2_p[7] + PosT2_p[3] + PosT2_p[4] + PosT2_p[5] + PosT2_p[6],
        "possessionGameT2": PosT2_g[7] + PosT2_g[3] + PosT2_g[4] + PosT2_g[5] + PosT2_g[6],
        "goalsPeriodT2": ~~totp_2.innerHTML,
        "goalsGameT2": ~~totg_2.innerHTML,
        "xGPeriodT2": xGfT2_p[7] + xGfT2_p[3] + xGfT2_p[4] + xGfT2_p[5] + xGfT2_p[6],
        "xGGameT2": xGfT2_g[7],
        "nameL1": "Line 1",
