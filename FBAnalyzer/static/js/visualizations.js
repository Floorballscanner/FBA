    ...
    function changeGame() {
        ...
        fetch("https://fbscanner.io/apis/games/" + game_id + "/")
            ...
            .then(data => {
                ...
                pldata1.addRows([
                    ['Line 1', gd.toc_g[0], Number(gd.xf_g[0]), Number(gd.xa_g[0]), Number(gd.gf_g[0].textContent), Number(gd.ga_g[0]. textContent), Number(gd.sf_g[0].textContent), Number(gd.sa_g[0].textContent), Number(gd.p_g[0].textContent), gd.stxGT1L1g_array[0] + gd.stxGT1L1g_array[1], gd.stxGT1L1g_array[2] + gd.stxGT1L1g_array[3] + gd.stxGT1L1g_array[4]],
